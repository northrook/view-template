...
final class Token
{
    public const int
        ...
        Slash       = 10_005,
        Equals      = 10_006,
        Quote       = 10_007; // single or double quote

    public const int
        Latte_TagOpen      = 10_010,
        Latte_TagClose     = 10_011,
        Latte_Name         = 10_012,
        Latte_CommentOpen  = 10_014,
        Latte_CommentClose = 10_015;

    public const int
        Html_TagOpen      = 10_020,
        Html_TagClose     = 10_021,
        Html_CommentOpen  = 10_022,
        Html_CommentClose = 10_023,
        Html_BogusOpen    = 10_024,
        Html_Name         = 10_025;
    ...
    {
        return $this->type > 0 && $this->type < 10_000;
    }
}
