...
/**
 * Test: Core\View\Template\Engine and auto-safe URL.
 */
...
$latte->addFilter('datastream', 'Core\View\Template\Essential\Filters::dataStream');
...
Assert::contains(
	'Runtime\Filters::escapeHtmlAttr(Runtime\Filters::safeUrl(($this->filters->upper)($url1)))',
