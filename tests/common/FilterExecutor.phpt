...
/**
 * Test: Core\View\Template\Runtime\FilterExecutor
 */

declare(strict_types=1);

use Core\View\Template\ContentType;
use Core\View\Template\Runtime\FilterExecutor;
...
test('HTML object handling in filters', function () {
	...
	// FilterInfo aware called as classic with Core\View\Template\Runtime\Html
	...
	// classic called as FilterInfo aware with Core\View\Template\Runtime\Html
