...
Assert::exception(
	...
	'Missing arguments in n:class (on line 1 at column 6)',
);
...
Assert::exception(
	...
	Core\View\Template\Exception\CompileException::class,
	'Unexpected attribute n:inner-class, did you mean n:inner-last? (on line 1 at column 6)',
);
