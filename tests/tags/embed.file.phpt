...
}, Core\View\Template\Exception\CompileException::class, 'Unexpected content inside {embed} tags (on line 1 at column 23)');
...
}, Core\View\Template\Exception\RuntimeException::class, "Cannot include undefined block 'outer'.");
...
}, Core\View\Template\Exception\RuntimeException::class, "Cannot include undefined block 'a'.");
