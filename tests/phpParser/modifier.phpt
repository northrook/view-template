...
$parser = new Core\View\Template\Compiler\TagParser($tokens);
...
__halt_compiler();
Core\View\Template\Compiler\Nodes\Php\ModifierNode
   filters: array (2)
   |  0 => Core\View\Template\Compiler\Nodes\Php\FilterNode
   ...
   |  |  |  |  value: Core\View\Template\Compiler\Nodes\Php\Expression\FilterCallNode
   |  |  |  |  |  expr: Core\View\Template\Compiler\Nodes\Php\Scalar\IntegerNode
   |  |  |  |  |  |  value: 20
   |  |  |  |  |  |  kind: 10
   |  |  |  |  |  |  position: 1:17 (offset 16)
   |  |  |  |  |  filter: Core\View\Template\Compiler\Nodes\Php\FilterNode
   |  |  |  |  |  |  name: Core\View\Template\Compiler\Nodes\Php\IdentifierNode
   |  |  |  |  |  |  |  name: 'round'
   ...
   |  1 => Core\View\Template\Compiler\Nodes\Php\FilterNode
   |  |  name: Core\View\Template\Compiler\Nodes\Php\IdentifierNode
   |  |  |  name: 'trim'
