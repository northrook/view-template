...
test('name validity', function () {
	...
	Assert::exception(fn() => Filters::renderHtmlAttribute('', ''), Core\View\Template\Exception\RuntimeException::class);
	Assert::exception(fn() => Filters::renderHtmlAttribute("name\n", ''), Core\View\Template\Exception\RuntimeException::class);
	Assert::exception(fn() => Filters::renderHtmlAttribute('name name', ''), Core\View\Template\Exception\RuntimeException::class);
	Assert::exception(fn() => Filters::renderHtmlAttribute('name"name', ''), Core\View\Template\Exception\RuntimeException::class);
});
