...
test('name validity', function () {
	...
	Assert::exception(fn() => Filters::renderXmlAttribute('', ''), Core\View\Template\Exception\RuntimeException::class);
	Assert::exception(fn() => Filters::renderXmlAttribute("name\n", ''), Core\View\Template\Exception\RuntimeException::class);
	Assert::exception(fn() => Filters::renderXmlAttribute('1name', ''), Core\View\Template\Exception\RuntimeException::class);
	Assert::exception(fn() => Filters::renderXmlAttribute('-name', ''), Core\View\Template\Exception\RuntimeException::class);
	Assert::exception(fn() => Filters::renderXmlAttribute('name name', ''), Core\View\Template\Exception\RuntimeException::class);
	Assert::exception(fn() => Filters::renderXmlAttribute('name&name', ''), Core\View\Template\Exception\RuntimeException::class);
	Assert::exception(fn() => Filters::renderXmlAttribute('name"name', ''), Core\View\Template\Exception\RuntimeException::class);
});
